# Generated by Django 3.1.7 on 2021-04-05 07:27
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gm100', models.BooleanField(blank=True, default=False, null=True)),
                ('gm100_quan', models.IntegerField(blank=True, default=0, null=True)),
                ('gm250', models.BooleanField(blank=True, default=False, null=True)),
                ('gm250_quan', models.IntegerField(blank=True, default=0, null=True)),
                ('gm500', models.BooleanField(blank=True, default=False, null=True)),
                ('gm500_quan', models.IntegerField(blank=True, default=0, null=True)),
                ('kg1', models.BooleanField(blank=True, default=False, null=True)),
